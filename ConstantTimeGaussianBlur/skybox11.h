...
public:
    ...
    void    D3D11Render( D3DXMATRIX* pmWorldViewProj, BOOL bColor, ID3D11DeviceContext* pd3dImmediateContext );
...
protected:
    ...
    ID3D11PixelShader* m_pPixelShader_Color;
    ID3D11PixelShader* m_pPixelShader_Gray;
