...
CSkybox11::CSkybox11()
{
    ...
    m_pPixelShader_Color = NULL;
    m_pPixelShader_Gray = NULL;
    m_pSam = NULL;
                                        ...
                                        ID3D11Texture2D* pCubeTexture, ID3D11ShaderResourceView* pCubeRV )
{
    ...
    SAFE_RELEASE( pBlobPS_Color );
    SAFE_RELEASE( pBlobPS_Gray );
...
void CSkybox11::D3D11Render( D3DXMATRIX* pmWorldViewProj, BOOL bColor, ID3D11DeviceContext* pd3dImmediateContext )
{
    HRESULT hr;
	...
	pd3dImmediateContext->PSSetShader( bColor ? m_pPixelShader_Color : m_pPixelShader_Gray, NULL, 0 );
...
void CSkybox11::OnD3D11DestroyDevice()
{
    ...
    SAFE_RELEASE( m_pPixelShader_Color );
    SAFE_RELEASE( m_pPixelShader_Gray );
